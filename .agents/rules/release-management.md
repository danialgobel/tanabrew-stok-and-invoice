...
1. **Wajib memperbarui `src/config/appRelease.ts`**:
   ...
   - Cantumkan **semua poin pembaruan** yang telah dikerjakan secara jelas, singkat, dan padat pada `highlights` dengan badge yang sesuai ("Baru", "Peningkatan", "Perbaikan", "Fitur").
